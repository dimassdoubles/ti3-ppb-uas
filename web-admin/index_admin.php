  ...
  <section id="container" class="">
	...
	if(isset($_REQUEST["page"])) {
		switch($_REQUEST["page"])
		{
			...
			case "displaykota" : include("displaykota.php");break;
			case "tambahkota" : include("tambahkota.php");break;
			case "editkota" : include("editkota.php");break;
			case "hapuskota" : include("hapuskota.php");break;
